...
* resource/aws_iam_role: Add support for exclusive policy management `inline_policy` and `managed_policy_arns` arguments ([#5904](https://github.com/hashicorp/terraform-provider-aws/issues/5904))
...
* resource/aws_lb_listener: Fix `default_action.forward.target_group` to have minimum of 1. ([#15112](https://github.com/hashicorp/terraform-provider-aws/issues/15112))
